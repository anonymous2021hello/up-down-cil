...
def print_metrics(hallucination_cap_dict, quiet=False):
    ...
    metric_string = "%0.01f\t%0.01f\t%0.01f\t%0.01f" %(
                                                  sentence_metrics['METEOR']*100,
                                                  sentence_metrics['CIDEr']*100,
                                                  sentence_metrics['CHAIRs']*100,
                                                  sentence_metrics['CHAIRi']*100)
    ...
    if not quiet:
        ...
        print ("METEOR\tCIDEr\tCHAIRs\tCHAIRi")
        print (metric_string)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--cap_file", type=str, default='generated_sentences/fc_beam5_test.json')
