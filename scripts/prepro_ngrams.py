...
if __name__ == "__main__":
  ...
  parser.add_argument('--dict_json', default='data/flickrtalk.json', help='output json file')
  parser.add_argument('--output_pkl', default='data/flickr-train', help='output pickle file')
