...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--dataset', type=str, default='robust-coco',
                    help='coco|flickr|robust-coco')
    ...
    parser.add_argument('--checkpoint_path', type=str, default='log/cexe-sup-kl-w0-reproduce',
    ...
    # misc
    parser.add_argument('--id', type=str, default='cexe-sup-kl-w0-reproduce',
    ...
    #Whether usign casual effect when caculating the reward.
    parser.add_argument('--cec', type=bool, default=False,
                    help='whether use causal effect critical')
    parser.add_argument('--cec_weight', type=float, default=0,
                    help='cec  weight.')

    #Whether regularizing cross entropy loss with casual effect.
    parser.add_argument('--cexe', type=bool, default=True,
                    help='whether regularizing xe loss with casual effect.')
    parser.add_argument('--cexe_weight', type=float, default=0,
                    help='KL_div  weight.')
    parser.add_argument('--cexe_after', type=int, default=0,
                    help='After what epoch we start causal effect xe?')
    parser.add_argument('--sup_tie', type=bool, default=False,
                    help='Whether supervising the tie branch?')
    parser.add_argument('--tie_weight', type=float, default=0,
                    help='weight.')
    parser.add_argument('--sup_nde', type=bool, default=False,
                    help='Whether supervising the nde branch?')
    parser.add_argument('--nde_weight', type=float, default=0,
                    help='weight.')
